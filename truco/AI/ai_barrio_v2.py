...
from .ai_barrio_v2_params import *
    ...
    def responder_envido(self, game_state: dict) -> dict:
        ...
        if envido_en_juego == 2:
            ...
            if envido_propio <= 20:
                ...
                probabilidad_de_querer = self.interpolate(envido_propio, 20, 25, RE_2_20_25_MIN, RE_2_20_25_MAX)
            elif envido_propio <= 29:
                probabilidad_de_querer = self.interpolate(envido_propio, 26, 29, RE_2_26_29_MIN, RE_2_26_29_MAX)
            else:
                probabilidad_de_querer = 1.0

            if self._probabilidad_a_decision(probabilidad_de_querer):
                if envido_propio <= 25:
                    probabilidad_de_subir = self.interpolate(envido_propio, 20, 25, SE_2_20_25_MIN, SE_2_20_25_MAX)
                elif envido_propio <= 29:
                    probabilidad_de_subir = self.interpolate(envido_propio, 26, 29, SE_2_26_29_MIN, SE_2_26_29_MAX)
                else:
                    probabilidad_de_subir = self.interpolate(envido_propio, 30, 33, SE_2_30_33_MIN, SE_2_30_33_MAX)
        ...
        # Envido, Envido
            ...
            if envido_propio <= 20:
                ...
                probabilidad_de_querer = self.interpolate(envido_propio, 20, 25, RE_4_20_25_MIN, RE_4_20_25_MAX)
            elif envido_propio <= 29:
                probabilidad_de_querer = self.interpolate(envido_propio, 26, 29, RE_4_26_29_MIN, RE_4_26_29_MAX)
            else:
                probabilidad_de_querer = self.interpolate(envido_propio, 26, 29, RE_4_30_33_MIN, RE_4_30_33_MAX)

            if self._probabilidad_a_decision(probabilidad_de_querer):
                if envido_propio <= 25:
                    probabilidad_de_subir = self.interpolate(envido_propio, 20, 25, SE_4_20_25_MIN, SE_4_20_25_MAX)
                elif envido_propio <= 29:
                    probabilidad_de_subir = self.interpolate(envido_propio, 26, 29, SE_4_26_29_MIN, SE_4_26_29_MAX)
                else:
                    probabilidad_de_subir = self.interpolate(envido_propio, 30, 33, SE_4_30_33_MIN, SE_4_30_33_MAX)
        ...
        # Envido, Envido, Real Envido
            ...
            if envido_propio <= 20:
                ...
                probabilidad_de_querer = self.interpolate(envido_propio, 20, 25, RE_7_20_25_MIN, RE_7_20_25_MAX)
            elif envido_propio <= 29:
                probabilidad_de_querer = self.interpolate(envido_propio, 26, 29, RE_7_26_29_MIN, RE_7_26_29_MAX)
            else:
                probabilidad_de_querer = self.interpolate(envido_propio, 26, 29, RE_7_30_33_MIN, RE_7_30_33_MAX)
    ...
    def _envido_propio_a_probabilidades(self, puntos: int, soy_mano: bool) -> float:
        if soy_mano:
            if puntos <= 7:
                ...
                return self.interpolate(puntos, 20, 25, CE_M_20_25_MIN, CE_M_20_25_MAX)
            elif puntos <= 29:
                return self.interpolate(puntos, 26, 29, CE_M_26_29_MIN, CE_M_26_29_MAX)
            else:
                return self.interpolate(puntos, 26, 29, CE_M_30_33_MIN, CE_M_30_33_MAX)
        else:
            if puntos <= 7:
                return CE_NM_0_7
            elif puntos <= 25:
